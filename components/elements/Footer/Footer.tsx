  ...
  return (
		<div className={styles.footerShadow}>
			...
			<footer className='pb-8'>
				<div className="flex justify-center font-title pt-2">
				...
				<div className="flex space-x-[2%] py-4 items-center justify-center">
					<a
						href="https://www.linkedin.com/in/raymondmagner1/"
						rel="noreferrer"
						target="_blank"
					>
						<svg
							...
							viewBox="0 0 448 512"
							className="h-10 w-10 hover:scale-[1.05]"
					...
					<a
						href="https://discordapp.com/users/488157747141935114"
						rel="noreferrer"
						target="_blank"
					>
						<svg
							xmlns="http://www.w3.org/2000/svg"
							viewBox="0 0 640 512"
							className="h-12 w-12 hover:scale-[1.05]"
							fill="var(--color-text-primary)"
						>
					...
					<a
						href="https://github.com/mrdrmitten"
						rel="noreferrer"
						target="_blank"
					>
						<svg
